...
public class DetailPanel
  ...
  private void initComponents() {
    ...
    clearMenuItem.setText(bundle.getString("DetailPanel.ClearLogMessageText")); // NOI18N
    ...
    filterMenu.setText(bundle.getString("DetailPanel.FilterMessages")); // NOI18N
    filterMenu.setActionCommand(" message filtering");

    everythingCheckBoxMenuItem.setText(bundle.getString("DetailPanel.FilterMessagesShowAll")); // NOI18N
    ...
    warningsCheckBoxMenuItem.setText(bundle.getString("DetailPanel.FilterMessagesShowErrorsAndWarnings")); // NOI18N
    ...
    errorsCheckBoxMenuItem.setText(bundle.getString("DetailPanel.FilterMessagesShowErrors")); // NOI18N
    ...
    noVehicleLabel.setText(bundle.getString("DetailPanel.NoVehicleAttached")); // NOI18N
    ...
    adapterStatusPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("DetailPanel.AdapterStatus"))); // NOI18N
    adapterStatusPanel.setLayout(new java.awt.BorderLayout());

    chkBoxEnable.setText(bundle.getString("DetailPanel.EnableAdapter")); // NOI18N
    ...
    statusFiguresPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("DetailPanel.VehicleStatus"))); // NOI18N
    statusFiguresPanel.setLayout(new java.awt.GridBagLayout());

    curPosLbl.setText(bundle.getString("DetailPanel.CurrentPosition")); // NOI18N
    ...
    curStateLbl.setText(bundle.getString("DetailPanel.CurrentState")); // NOI18N
    gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    logPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("DetailPanel.Messages"))); // NOI18N
    ...
    tabbedPane.addTab(bundle.getString("DetailPanel.GeneralStatus"), overviewTabPanel); // NOI18N
