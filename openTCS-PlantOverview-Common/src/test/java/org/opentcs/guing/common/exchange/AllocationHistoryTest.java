...
public class AllocationHistoryTest {
  ...
  private Path path1 = new Path("path", point1.getReference(), point2.getReference());
  private Path path2 = new Path("path", point2.getReference(), point3.getReference());
  ...
  public void returnEmptyEntryForVehicleClaimingAndAllocatingNoResources() {
    ...
    assertThat(result.getCurrentAllocatedResources()).isEmpty();
  ...
  public void returnEmptyPreviousAllocationsOnFirstUpdate() {
    ...
    assertThat(result.getCurrentAllocatedResources())
        .hasSize(1)
