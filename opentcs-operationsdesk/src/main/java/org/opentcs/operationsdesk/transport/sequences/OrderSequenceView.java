...
public class OrderSequenceView
  ...
  public final void initFields() {
    ...
    textOrderTypes.setText(String.join(", ", getOrderSequence().getOrderTypes()));
   ...
   */
    ...
    private void initComponents() {
        ...
        labelOrderTypes = new javax.swing.JLabel();
        textOrderTypes = new javax.swing.JTextField();
        ...
        labelOrderTypes.setFont(labelOrderTypes.getFont());
        labelOrderTypes.setText(bundle.getString("orderSequenceView.panel_general.label_orderTypes.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 4, 0, 4);
        jPanel1.add(labelOrderTypes, gridBagConstraints);

        textOrderTypes.setEditable(false);
        textOrderTypes.setColumns(10);
        textOrderTypes.setFont(textOrderTypes.getFont());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.weightx = 0.5;
        jPanel1.add(textOrderTypes, gridBagConstraints);
  ...
  // CHECKSTYLE:OFF
    ...
    private javax.swing.JLabel labelOrderTypes;
    ...
    private javax.swing.JTextField textOrderTypes;
