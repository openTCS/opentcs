...
public interface TransportOrderHistoryCodes {
   ...
   * <p>
   * The history entry's supplements list contains the reasons for the deferral.
   * </p>
   */
   ...
   * <p>
   * The history entry's supplements list contains one item with the name of the vehicle the
   * transport order was assigned to.
   * </p>
   */
   ...
   * <p>
   * The history entry's supplements list contains one item with the name of the vehicle the
   * transport order was reserved for.
   * </p>
   */
   ...
   * <p>
   * The history entry's supplements list contains on item with the name of the new processing
