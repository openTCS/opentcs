...
export KEYSTORE_FILEPATH="${OUTPUTDIR}/keystore.jks"
export TRUSTSTORE_FILEPATH="${OUTPUTDIR}/truststore.jks"
...
${KEYTOOL_PATH} -importcert -alias openTCS -file ${CERTIFICATE_FILEPATH} -storepass ${PASSWORD} -keystore ${TRUSTSTORE_FILEPATH} -noprompt 2>/dev/null
