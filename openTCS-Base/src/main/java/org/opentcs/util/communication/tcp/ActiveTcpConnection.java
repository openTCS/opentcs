...
public final class ActiveTcpConnection
  ...
  public ActiveTcpConnection(IncomingTelegramHandler handler,
    ...
    telegramHandler = requireNonNull(handler, "handler");
    telegramTokenizer = requireNonNull(tokenizer, "tokenizer");
    remoteHost = requireNonNull(host, "host");
    remotePort = checkPositionIndex(port, 65535, "port");
    receiveTimeout = checkPositionIndex(readTimeout,
                                        Integer.MAX_VALUE,
                                        "readTimeout");
