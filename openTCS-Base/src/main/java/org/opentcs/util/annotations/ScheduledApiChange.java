...
/**
 * Marks an API detail (class, method, field) that is scheduled for an
 * incompatible change.
 * This annotation is intended to be used as a supplement for @Deprecated for
 * two purposes:
 * <ol>
 * <li>For users of the openTCS API to gain knowledge about upcoming changes.
 * </li>
 * <li>For openTCS developers to easily find pending changes during pre-release
 * cleanups.</li>
 * </ol>
 *
