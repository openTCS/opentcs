...
public interface VehicleManager {
  ...
  /**
   * Publishes the given event via the kernel's event mechanism.
   *
   * @param event The event.
   */
  @ScheduledApiChange(when = "4.0.0",
                      details = "Remove default implementation")
  default void publishEvent(CommunicationAdapterEvent event) {
    // Do nada.
  };
}
