...
public final class TransportOrder
   ...
   * @deprecated Will be removed with release 4.0.0. Use other constructor
   * instead.
   */
  @Deprecated
  @ScheduledApiChange(when = "4.0.0")
  public TransportOrder(int objectID, String name,
    ...
    this(objectID, name, destinations, System.currentTimeMillis());
  }
