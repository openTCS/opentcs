...
public interface Kernel
   ...
   * execute this method.
   */
  <T extends TCSObject<T>> Set<T> getTCSObjects(@Nullable Class<T> clazz,
                                                Pattern regexp)
      throws CredentialsException;
   ...
   * @throws CredentialsException If the calling client is not allowed to
   * execute this method.
   * @deprecated Call {@link #withdrawTransportOrder(org.opentcs.data.TCSObjectReference, boolean, boolean)}
   * instead. Scheduled for removal with release 4.0.0.
   */
  @Deprecated
  @ScheduledApiChange(when = "4.0.0")
  default void withdrawTransportOrder(TCSObjectReference<TransportOrder> ref,
                                      boolean disableVehicle)
      throws ObjectUnknownException, CredentialsException {
    withdrawTransportOrder(ref, false, disableVehicle);
  }
   ...
   * @throws CredentialsException If the calling client is not allowed to
   * execute this method.
   * @deprecated Call {@link #withdrawTransportOrderByVehicle(org.opentcs.data.TCSObjectReference, boolean, boolean)}
   * instead. Scheduled for removal with release 4.0.0.
   */
  @Deprecated
  @ScheduledApiChange(when = "4.0.0")
  default void withdrawTransportOrderByVehicle(
      TCSObjectReference<Vehicle> vehicleRef,
      boolean disableVehicle)
      throws ObjectUnknownException, CredentialsException {
    withdrawTransportOrderByVehicle(vehicleRef, false, disableVehicle);
  }
