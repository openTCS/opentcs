...
public class V7PlantModelTO
  ...
  public V7PlantModelTO setPoints(
      @Nonnull
      List<PointTO> points
  ) {
  ...
  public V7PlantModelTO setPaths(
      @Nonnull
      List<PathTO> paths
  ) {
  ...
  public V7PlantModelTO setVehicles(
      @Nonnull
  ...
  public V7PlantModelTO setLocationTypes(
      @Nonnull
  ...
  public V7PlantModelTO setLocations(
      @Nonnull
  ...
  public V7PlantModelTO setBlocks(
      @Nonnull
      List<BlockTO> blocks
  ) {
  ...
  public V7PlantModelTO setVisualLayout(
      @Nonnull
  ...
  public V7PlantModelTO setProperties(
      @Nonnull
  ...
  /**
   * Unmarshalls an instance of this class from the given XML representation.
   *
   ...
   */
  public static V7PlantModelTO fromXml(
      @Nonnull
      Reader reader
  )
      throws IOException {
    ...
    try {
      return (V7PlantModelTO) createUnmarshaller().unmarshal(reader);
    }
    catch (JAXBException | SAXException exc) {
  ...
  private static JAXBContext createContext()
      throws JAXBException {
    return JAXBContext.newInstance(V7PlantModelTO.class);
  }
