...
class V004DrivingCoursePersistenceTest {
  ...
  void persistAndMaterializePoints()
    ...
    plantModel.getPoints().get(0).setType(PointTO.Type.REPORT_POSITION);
    ...
    assertThat(parsedModel.getPoints().get(0).getType(), is(equalTo(PointTO.Type.REPORT_POSITION)));
  ...
  void persistAndMaterializePaths()
    ...
    plantModel.getPaths().get(0).getPeripheralOperations().add(
        new PeripheralOperationTO()
            ...
            .setExecutionTrigger(PeripheralOperationTO.ExecutionTrigger.BEFORE_MOVEMENT)
    ...
    assertThat(
        ...
        is(equalTo(PeripheralOperationTO.ExecutionTrigger.BEFORE_MOVEMENT))
    );
    assertThat(
                ...
                (LocationTO) new LocationTO()
                    .setLocationLayout(
                        new LocationTO.LocationLayout()
                            ...
                            .setyLabelOffset(20L)
                            .setLocationRepresentation(
                                org.opentcs.util.persistence.v004.LocationRepresentation.WORKING_ALT_1
                            )
                            .setLayerId(0)
                    )
                    .setName(UUID.randomUUID().toString())
