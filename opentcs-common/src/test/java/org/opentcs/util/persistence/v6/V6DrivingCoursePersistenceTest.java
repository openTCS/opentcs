...
import org.opentcs.util.persistence.v6.BlockTO.BlockLayout;
import org.opentcs.util.persistence.v6.LocationTO.LocationLayout;
import org.opentcs.util.persistence.v6.LocationTypeTO.LocationTypeLayout;
import org.opentcs.util.persistence.v6.PathTO.ControlPoint;
import org.opentcs.util.persistence.v6.PathTO.PathLayout;
import org.opentcs.util.persistence.v6.PointTO.PointLayout;
import org.opentcs.util.persistence.v6.VehicleTO.VehicleLayout;

/**
 */
public class V6DrivingCoursePersistenceTest {

  private V6PlantModelTO plantModel;
  ...
  void persistAndMaterializeModelAttributes()
    ...
    assertThat(parsedModel.getVersion(), is(equalTo("6.0.0")));
  ...
  void persistAndMaterializePoints()
    ...
    assertThat(parsedModel.getPoints().get(0).getPointLayout().getPositionX(), is(20L));
    assertThat(parsedModel.getPoints().get(0).getPointLayout().getPositionY(), is(30L));
  ...
  void persistAndMaterializeLocations()
    ...
    assertThat(parsedModel.getLocations().get(0).getLocationLayout().getPositionX(), is(20L));
    assertThat(parsedModel.getLocations().get(0).getLocationLayout().getPositionY(), is(30L));
  ...
  private String toXml(V6PlantModelTO plantModel)
      throws IOException {
