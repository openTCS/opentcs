 ...
 */
public class LegacyModelPersistor
   ...
   */
  @Inject
  public LegacyModelPersistor(StatusPanel statusPanel,
  ...
  private void close(CourseModel courseModel, File file)
      throws IOException {
    File outFile = file.getName().endsWith(LegacyModelConstants.FILE_ENDING_OPENTCS)
        ? file
        : new File(file.getParentFile(),
                   file.getName() + "." + LegacyModelConstants.FILE_ENDING_OPENTCS);
