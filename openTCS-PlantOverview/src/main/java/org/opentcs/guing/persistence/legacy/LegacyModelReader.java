...
/**
 * Implementation of <code>ModelFileReader</code> to deserialize a <code>SystemModel</code>.
 *
 * @author Philipp Seifert (Fraunhofer IML)
 */
public class LegacyModelReader
   ...
   */
  @Inject
  public LegacyModelReader(Provider<SystemModel> systemModelProvider,
  ...
  public Optional<SystemModel> deserialize(File file)
    ...
    try {
      ...
      for (CourseElement courseElement : courseModel.getCourseElements()) {
        // Ignore static routes to prevent NPE
        if (courseElement instanceof StaticRoute) {
          continue;
        }
  ...
  public FileFilter getDialogFileFilter() {
    return LegacyModelConstants.DIALOG_FILE_FILTER;
  }
