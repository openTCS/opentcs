 ...
 */
public class IntegrationLevelRespectAction
    extends AbstractAction {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(IntegrationLevelRespectAction.class);
  /**
   * Sets the vehicle's integration level to TO_BE_RESPECTED.
   */
  public static final String ID = "course.vehicle.integrationLevelRespect";
  /**
   * The vehicle.
   */
  ...
  @Inject
  public IntegrationLevelRespectAction(@Assisted VehicleModel vehicleModel,
