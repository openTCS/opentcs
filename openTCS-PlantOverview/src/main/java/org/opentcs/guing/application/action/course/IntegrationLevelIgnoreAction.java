 ...
 */
public class IntegrationLevelIgnoreAction
    extends AbstractAction {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(IntegrationLevelIgnoreAction.class);
  /**
   * Sets the vehicle's integration level to TO_BE_IGNORED.
   */
  public static final String ID = "course.vehicle.integrationLevelIgnore";
  /**
   * The vehicle.
   */
  ...
  @Inject
  public IntegrationLevelIgnoreAction(@Assisted VehicleModel vehicleModel,
