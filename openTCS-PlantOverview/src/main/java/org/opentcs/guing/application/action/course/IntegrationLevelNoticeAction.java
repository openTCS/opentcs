 ...
 */
public class IntegrationLevelNoticeAction
    extends AbstractAction {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(IntegrationLevelNoticeAction.class);
  /**
   * Sets the vehicle's integration level to TO_BE_NOTICED.
   */
  public static final String ID = "course.vehicle.integrationLevelNotice";
  /**
   * The vehicle.
   */
  ...
  @Inject
  public IntegrationLevelNoticeAction(@Assisted VehicleModel vehicleModel,
