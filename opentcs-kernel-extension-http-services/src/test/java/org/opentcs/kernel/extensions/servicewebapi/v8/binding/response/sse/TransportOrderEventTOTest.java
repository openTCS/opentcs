...
class TransportOrderEventTOTest {
  ...
  void jsonSample() {
    TransportOrderEventTO to = new TransportOrderEventTO(
        createTransportOrder(TransportOrderTO.StateTO.RAW),
        createTransportOrder(TransportOrderTO.StateTO.BEING_PROCESSED)
    );

    Approvals.verify(jsonBinder.toJson(to));
  }

  private TransportOrderTO createTransportOrder(
      TransportOrderTO.StateTO state
  ) {
        ...
        .setDriveOrders(
            List.of(
                new DriveOrderTO()
                    ...
                    .setRoute(
                        new DriveOrderTO.RouteTO()
                            .setSteps(
                                List.of(
                                    new DriveOrderTO.RouteTO.StepTO()
                                        .setPath("path-1")
                    ...
                    .setState(DriveOrderTO.StateTO.TRAVELLING)
            )
        )
