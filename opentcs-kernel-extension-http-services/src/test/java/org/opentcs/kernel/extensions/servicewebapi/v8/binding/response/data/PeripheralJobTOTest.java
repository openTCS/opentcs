...
/**
 * Tests for {@link PeripheralJobTO}.
 */
public class PeripheralJobTOTest {
  ...
  void jsonSampleMinimal() {
    Approvals.verify(jsonBinder.toJson(createPeripheralJobMinimal()));
  }

  @Test
  void jsonSampleFull() {
    Approvals.verify(jsonBinder.toJson(createPeripheralJobFull()));
  }

  private PeripheralJobTO createPeripheralJobMinimal() {
    ...
    return new PeripheralJobTO()
        ...
        .setState(PeripheralJobTO.StateTO.FINISHED)
        .setCreationTime(time)
        .setFinishedTime(null);
  }

  private PeripheralJobTO createPeripheralJobFull() {
    Instant time = Instant.parse("2025-07-22T12:03:00Z");
    return new PeripheralJobTO()
        .setName("job-1")
