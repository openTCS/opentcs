...
import org.opentcs.kernel.extensions.servicewebapi.v8.binding.request.converter.EnvelopeConverter;
...
class PlantModelHandlerTest {
  ...
  void setUp() {
    ...
    handler = new PlantModelHandler(
        orderService,
        executorWrapper,
        new PlantModelConverter(
            new org.opentcs.kernel.extensions.servicewebapi.v8.binding.response.converter.PointConverter(),
            new org.opentcs.kernel.extensions.servicewebapi.v8.binding.response.converter.PathConverter(),
            new org.opentcs.kernel.extensions.servicewebapi.v8.binding.response.converter.LocationTypeConverter(),
            new org.opentcs.kernel.extensions.servicewebapi.v8.binding.response.converter.LocationConverter(),
            new org.opentcs.kernel.extensions.servicewebapi.v8.binding.response.converter.BlockConverter(),
  ...
  void putPlantModel() {
    ...
    handler.putPlantModel(
        new PutPlantModelRequestTO("name")
            .setPoints(
                List.of(
  ...
  void getPlantModel() {
    ...
    // Act
    GetPlantModelResponseTO to
        = handler.getPlantModel();

    // Assert
    then(orderService).should().getPlantModel();
    assertThat(to.getName()).isEqualTo("some-plant-model");
