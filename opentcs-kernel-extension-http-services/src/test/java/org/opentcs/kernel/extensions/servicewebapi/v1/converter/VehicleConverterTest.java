...
class VehicleConverterTest {
  ...
  void checkToGetVehicleResponseTO() {
    ...
    assertThat(result.getIntegrationLevel(), is(VehicleTO.IntegrationLevel.TO_BE_UTILIZED));
    assertThat(result.isPaused(), is(true));
    assertThat(result.getProcState(), is(VehicleTO.ProcState.PROCESSING_ORDER));
    ...
    assertThat(result.getState(), is(VehicleTO.State.EXECUTING));
  ...
  void checkToVehicleStatusMessage() {
    ...
    assertThat(message.getIntegrationLevel(), is(VehicleTO.IntegrationLevel.TO_BE_UTILIZED));
    assertThat(message.isPaused(), is(true));
    assertThat(message.getProcState(), is(VehicleTO.ProcState.PROCESSING_ORDER));
    ...
    assertThat(message.getState(), is(VehicleTO.State.EXECUTING));
