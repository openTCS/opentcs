...
class PeripheralJobHandlerTest {
  ...
  void setUp() {
    ...
    peripheralJobConverter = new PeripheralJobConverter();
  ...
  void retrievePeripheralJobsUnfiltered() {
    ...
    // Act
    List<PeripheralJobTO> result = handler.getPeripheralJobs(null, null);
  ...
  void retrievePeripheralJobsFilteredByRelatedVehicle() {
    ...
    List<PeripheralJobTO> result = handler.getPeripheralJobs("some-vehicle", null);
  ...
  void retrievePeripheralJobsFilteredByRelatedTransportOrder() {
    ...
    // Act & Assert: happy path
    List<PeripheralJobTO> result = handler.getPeripheralJobs(null, "some-order");
  ...
  void retrievPeripheralJobByName() {
    ...
    // Act & Assert: happy path
    PeripheralJobTO result = handler.getPeripheralJobByName("some-job");
