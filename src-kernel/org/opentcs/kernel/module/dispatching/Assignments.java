...
final class Assignments {
   ...
   * executed.
   */
  private static final boolean mustAssignAll;

  static {
    mustAssignAll = configStore.getBoolean(
        "mustAssignAll",
        false,
  ...
  public static SortedSet<TransportOrder> getOrdersForVehicle(
    ...
    SortedSet<TransportOrder> transportOrders =
        new TreeSet<>(TransportOrder.ageComparator);
    SortedSet<TransportOrder> vehicleSpecificOrders =
        new TreeSet<>(TransportOrder.ageComparator);
  ...
  public static SortedSet<TransportOrder> getOrdersForVehicle(
    ...
    SortedSet<TransportOrder> result =
        new TreeSet<>(TransportOrder.ageComparator);
