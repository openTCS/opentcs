 ...
 */
public class SimpleRechargeStrategyTest {
...
//      + " problem that SimpleRechargeStrategy depends on a Kernel instance")
  ...
  public void testNotNullWhenARechargeLocationInModel() {
    ...
    SimpleRechargeStrategy strategy = new SimpleRechargeStrategy(kernel, router);

    assertNotNull(strategy.getRechargeLocation(vehicle));
  }
  ...
  public void testNullWhenNoRechargeLocationInModel() {
    ...
    assertNull(strategy.getRechargeLocation(vehicle));
