...
public interface RemoteKernel
   ...
   * registry.
   */
  String registrationName = "org.opentcs.remote.rmi.RemoteKernel";
  /**
   * The default/guest user name.
   */
  String guestUser = "Alice";
  /**
   * The default/guest password.
   */
  String guestPassword = "xyz";
  ...
  Message publishMessage(ClientID clientID, String message, Message.Type type)
      throws CredentialsException, RemoteException;
  ...
  @CallPermissions({UserPermission.MODIFY_MODEL})
  void attachResource(ClientID clientID, TCSResourceReference<?> resource,
                      TCSResourceReference<?> newResource)
      throws CredentialsException, ObjectUnknownException, RemoteException;

  @CallPermissions({UserPermission.MODIFY_MODEL})
  void detachResource(ClientID clientID, TCSResourceReference<?> resource,
  ...
  @CallPermissions({UserPermission.READ_DATA})
  Set<ConfigurationItemTO> getConfigurationItems(ClientID clientID)
      throws CredentialsException, RemoteException;

  @CallPermissions({UserPermission.CHANGE_CONFIGURATION})
  void setConfigurationItem(ClientID clientID, ConfigurationItemTO itemTO)
      throws CredentialsException, RemoteException;
