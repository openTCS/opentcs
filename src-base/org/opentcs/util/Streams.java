...
public final class Streams {
   ...
   */
  private static final int initialGrowingBufferSize = 10000;
  ...
  public static InputStream getInputStreamToEndTag(InputStream inStream,
    ...
    if (endTag == null) {
      throw new NullPointerException("endTag is null");
    }

    if (endTag.length == 0) {
      throw new IllegalArgumentException("endTag has zero elements");
    }
  ...
  public static byte[] getCompleteInputStream(InputStream inStream)
    ...
    int bufferSize = initialGrowingBufferSize;
    int offset = 0;
    int bytesRead = 0;
