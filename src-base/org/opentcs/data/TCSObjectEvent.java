 ...
 */
public final class TCSObjectEvent
    extends TCSEvent
  ...
  /**
   * Returns the object which this event is associated with.
   *
   * @return The object which this event is associated with.
   * @deprecated Use <code>getCurrentObjectState()</code>,
   * <code>getPreviousObjectState()</code> or
   * <code>getCurrentOrPreviousObjectState()</code> instead.
   */
  public TCSObject<?> getAssociatedObject() {
    return getCurrentOrPreviousObjectState();
  }
