...
import org.opentcs.util.persistence.v002.GroupTO;
import org.opentcs.util.persistence.v002.LocationTO;
import org.opentcs.util.persistence.v002.LocationTO.Link;
import org.opentcs.util.persistence.v002.LocationTypeTO;
import org.opentcs.util.persistence.v002.MemberTO;
import org.opentcs.util.persistence.v002.PathTO;
import org.opentcs.util.persistence.v002.PathTO.ActionsType;
import org.opentcs.util.persistence.v002.PathTO.ActionsType.Action;
import org.opentcs.util.persistence.v002.PathTO.ActionsType.Orientation;
import org.opentcs.util.persistence.v002.PathTO.LockType;
import org.opentcs.util.persistence.v002.PathTO.MaxVelocityType;
import org.opentcs.util.persistence.v002.PointTO;
import org.opentcs.util.persistence.v002.PointTO.OutgoingPath;
import org.opentcs.util.persistence.v002.PropertyTO;
import org.opentcs.util.persistence.v002.StaticRouteTO;
import org.opentcs.util.persistence.v002.StaticRouteTO.Hop;
import org.opentcs.util.persistence.v002.V002PlantModelTO;
import org.opentcs.util.persistence.v002.VehicleTO;
import org.opentcs.util.persistence.v002.VisualLayoutTO;
import org.opentcs.util.persistence.v002.VisualLayoutTO.ModelLayoutElement;
 ...
 */
public class V002DrivingCoursePersistenceTest {

  private static final Logger LOG = LoggerFactory.getLogger(V002DrivingCoursePersistenceTest.class);

  public V002DrivingCoursePersistenceTest() {
  }
  ...
  public void testToXml()
      throws IOException {
    V002PlantModelTO model = new V002PlantModelTO();
