...
<xsl:stylesheet version="1.0"
  ...
  <!-- Import the original DocBook FO stylesheet as a template we modify -->
  <xsl:import href="classpath:/docbook/fo/docbook.xsl"/>
  
  <!-- Import our custom titlepage stylesheet -->
  <!-- This would first need to be generated from the corresponding XML file -->
  <!--<xsl:import href="classpath:/opentcs-jdocbook-style/xslt/opentcs-fo-titlepage.xsl"/>-->
