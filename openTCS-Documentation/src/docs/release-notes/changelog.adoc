...
** Add claimed and allocated resources to the vehicle state and vehicle status message specification of the web API.
** Add the precise position to the vehicle state message specification of the web API.
* Other changes:
