...
* New features:
** Properly specify and implement claim semantics in the scheduler, allowing custom scheduling strategies to take vehicles' planned future resource allocations into account.
* Bugs fixed:
