...
. In the plant overview client, right-click on the vehicle and select menu:Context menu[Withdraw transport order > ...and disable vehicle] to disable the vehicle for transport order processing.
